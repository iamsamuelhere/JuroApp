...
class EntertainmentChat extends StatefulWidget {
  @override
  _EntertainmentChatState createState() => _EntertainmentChatState();
}

class _EntertainmentChatState extends State<EntertainmentChat> {
  final Query<Map<String, dynamic>> _usersStream = FirebaseFirestore.instance
      .collection('EntertainmentChats')
      .orderBy('date', descending: true);
  CollectionReference msg =
      FirebaseFirestore.instance.collection("EntertainmentChats");
  bool isme = false;
